...
class CheckboxCell: UITableViewCell, ReusableView {
    ...
    private func setupUI() {
        ...
        checkImg.image = Images.check_empty
        ...
        { (checkImg, titleLabel, contentView) in
            checkImg.width == Images.check_empty!.size.width
    ...
    func setup(item: CheckboxItemModel) {
        checkImg.image = item.selected ? Images.check_selected : Images.check_empty
